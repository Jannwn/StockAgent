...
FUND_ADD_TEXT="""
        根据市场调研,我们发现每个宏观板块都有一定的周期,其中相关概念题材的公司会经历一段价值高估到价值低估再到价值高估的波动过程.
        我们希望你能够结合实时市场信息,判断目前对该行业或板块的估值处于什么阶段.我们尤其希望关注从价值低估到价值回归正常估值区间的过程.
        请你根据以下条件,给出你对该板块的估值:
        1. 板块的历史估值:我们希望你能够分析该板块过去一段时间内的估值情况,包括历史高点、历史低点、历史平均估值等.
        2. 板块的当前估值:我们希望你能够根据当前市场情况,给出该板块的当前估值以及以后上升下降的趋势预估.
        结合这一段时间的基本供需关系/网络情绪/新闻/地理政治气候行业政策等因素,给出你对该板块的判断

        """


SENT_SYS_TEXT="""
        你是一个专业的A股市场分析师,擅长解读新闻对股票走势的影响.
